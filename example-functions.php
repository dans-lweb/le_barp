...
add_action( 'cmb2_admin_init', 'le_barp_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function le_barp_register_demo_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_le_barp_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'le_barp_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'le_barp_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'le_barp_before_row_if_2', // callback
...
add_action( 'cmb2_admin_init', 'le_barp_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function le_barp_register_about_page_metabox() {

	// Start with an underscore to hide fields from custom fields list
	$prefix = '_le_barp_about_';
